...
let price8 = document.querySelector('div.price8')
let procent8 = document.querySelector('div.procent8')
let img8 = document.querySelector('#img8')

let simbol9 = document.querySelector('div.simbol9')
let price9 = document.querySelector('div.price9')
let procent9 = document.querySelector('div.procent9')
...
const prices = [price1, price2, price3, price4, price5, price6, price7, price8, price9]
const procent = [procent1, procent2, procent3, procent4, procent5, procent6, procent7, procent8, procent9]
